...
export function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 sm:p-6">
      <Alert className="max-w-4xl mx-auto bg-[#0F1F3D] text-white border-[#E8621A] border shadow-2xl">
        <Cookie className="w-5 h-5 text-[#E8621A]" />
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 ml-2">
          ...
          <Button
            onClick={accept}
            size="sm"
            className="flex-shrink-0 bg-[#E8621A] hover:bg-[#d05518] text-white border-0 font-semibold"
          >
            Verstanden
          </Button>
        </div>
