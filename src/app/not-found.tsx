  ...
  return (
    <div className="flex-1 flex items-center justify-center py-20 bg-[#F5F5F5]">
      <div className="text-center max-w-lg mx-auto px-4">
        <div className="font-heading text-[120px] font-bold text-[#6397cc] leading-none opacity-10 select-none">
          404
        </div>
        <div className="-mt-8 relative z-10">
          <h1 className="font-heading text-3xl font-bold text-[#6397cc] mb-3">
