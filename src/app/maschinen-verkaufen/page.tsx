      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
              ...
              <ul className="space-y-3">
                {vorteile.map((v) => (
                  <li key={v} className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-[#E8621A] flex-shrink-0 mt-0.5" />
            ...
            <div className="bg-[#0F1F3D] rounded-lg p-7 space-y-3">
              ...
              <a
                href="tel:+4956057068"
                className="flex items-center gap-3 text-white hover:text-[#E8621A] font-semibold transition-colors"
              >
            ...
            <div className="bg-white rounded-lg p-7 border border-gray-200">
              <h3 className="font-heading font-bold text-[#0F1F3D] text-lg mb-3">
                Was wir ankaufen
              </h3>
