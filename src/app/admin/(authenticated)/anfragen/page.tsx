...
export default async function AdminAnfragenPage() {
  ...
  return (
    <div className="p-8">
      <div className="mb-6">
        <h1 className="font-heading text-3xl font-bold text-[#0F1F3D]">Anfragen</h1>
        <p className="text-gray-500 text-sm mt-1">
          {anfragen.length} Anfragen insgesamt
          {ungelesen > 0 && <span className="ml-2 text-[#E8621A] font-semibold">· {ungelesen} ungelesen</span>}
        </p>
      </div>
